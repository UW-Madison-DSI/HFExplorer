...
export default BaseView.extend(_.extend({}, Loadable, {
	...
	className: 'shadowed pdf document',
	template: template(``),
	...
	getWidth: function() {
		...
		// if not rendered yet, allow space for scrollbar
		//
		let scrollbarWidth = this.canvas? 0 : 15;
		return this.el.clientWidth - scrollbarWidth;
	},
	...
	getHeight: function() {
		...
		// if not rendered yet, allow space for scrollbar
		//
		let scrollbarHeight = this.canvas? 0 : 15;
		return this.el.clientHeight - scrollbarHeight;
	},
